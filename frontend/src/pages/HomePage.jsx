...
export const HomePage = () => {
  ...
  return (
    <div className="space-y-8 lg:space-y-10 pb-12">
      ...
      {/* =========================================================================
          8. STORE DIRECTIONS & GOOGLE MAP
         ========================================================================= */}
      <section className="w-full max-w-[1520px] mx-auto px-4 sm:px-8">
        <div className="text-center max-w-2xl mx-auto mb-8">
          <span className="text-xs font-bold tracking-widest text-brand-cyan uppercase">Visit Us In Person</span>
          <h2 className={`text-3xl font-extrabold mt-1 font-heading ${isDark ? 'text-white' : 'text-slate-900'}`}>
            Digha Flagship Optical Store
          </h2>
          <p className={`text-sm mt-2 ${isDark ? 'text-slate-400' : 'text-slate-600'}`}>
            Experience our full inventory of luxury frames, automated lens cutting lab, and clinical doctor consultation desk.
          </p>
        </div>

        <div className={`rounded-3xl p-6 lg:p-8 grid grid-cols-1 lg:grid-cols-3 gap-8 items-center border-2 ${
          isDark ? 'bg-[#0A192F]/80 border-white/15' : 'bg-white border-slate-300 shadow-sm'
        }`}>
          <div className="space-y-4">
            <div className="flex items-start gap-3">
              <MapPin className="w-6 h-6 text-brand-cyan shrink-0 mt-1" />
              <div>
                <h4 className={`text-base font-bold ${isDark ? 'text-white' : 'text-slate-900'}`}>Netra Unnayan</h4>
            ...
            <div className={`space-y-1 text-xs pt-2 border-t ${
              ...
              <p><strong>Phone / WhatsApp:</strong> +91 9382293614</p>
              <p><strong>Email:</strong> netraunnayan7@gmail.com</p>
              <p><strong>Timings:</strong> 9:30 AM – 8:30 PM (Open 7 Days)</p>
            </div>
          ...
          <div className="lg:col-span-2 rounded-2xl overflow-hidden border border-slate-200 dark:border-white/10 h-72 sm:h-80 bg-slate-900 relative">
            <iframe
              title="Netra Unnayan Location Map"
